...
Please note that you will be completing everything on the  <a href = 'https://test.arcticdata.io' target='_blank'>test site</a> for the training. In the future if you are unsure about doing anything with a dataset, the test site is a good place to try things out!

## Exercise 1 {.exercise}
This part of the exercise walks you through submitting data through the web form on the development version of our website: <a href = 'https://test.arcticdata.io' target='_blank'>test.arcticdata.io</a>
